...
export READING_AGENT_INTERNAL_URL="${READING_AGENT_INTERNAL_URL:-http://127.0.0.1:8767}"
export NEXT_PUBLIC_READING_AGENT_URL="${NEXT_PUBLIC_READING_AGENT_URL:-http://${LAN_IP}:8767/interactive_video_agent.html}"
...
start_server() {
  ...
  setsid env \
    ...
    READING_AGENT_INTERNAL_URL="$READING_AGENT_INTERNAL_URL" \
    NEXT_PUBLIC_READING_AGENT_URL="$NEXT_PUBLIC_READING_AGENT_URL" \
