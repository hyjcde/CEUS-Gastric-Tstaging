          ...
          <div className="bg-linear-to-br from-neutral-900/90 to-neutral-800/50 border border-white/10 rounded-2xl p-6 shadow-2xl space-y-6">
            <div className="flex items-start justify-between gap-4">
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-full border border-white/10 text-[10px] uppercase tracking-widest text-gray-300 flex items-center gap-2 hover:bg-white/10 transition-colors"
              >
                <Download size={16} />
