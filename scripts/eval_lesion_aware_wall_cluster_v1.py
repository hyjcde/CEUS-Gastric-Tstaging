...
def main() -> int:
    ...
    summary = {
        ...
        "cases": summaries,
        "note": (
            "Scores wait for a doctor line. provisional_lesion_axis is algorithm smoke only. "
            "Does not unlock cT."
        ),
    }
    ...
    readme = (
        ...
        "If wall_source is provisional_lesion_axis, do not treat panels as "
        "agreement with a doctor line.\n"
    )
